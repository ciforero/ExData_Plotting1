##
## This function will create/replace a graphic file plot2.png
## showing a plot of the Global Active Power value vs Date
...
plot2 <- function() {
  ...
  par(mar=c(4,6,4,1))
  with(myNewData,plot(DateFormat,GlobalActivePower_num,type="l",ylab="Global Active Power (kilowatts)",xlab=""))
  dev.off()
